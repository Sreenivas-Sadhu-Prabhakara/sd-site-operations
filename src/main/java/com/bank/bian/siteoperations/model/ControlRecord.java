package com.bank.bian.siteoperations.model;
...
/**
 * The BIAN control record for this service domain: "Site Operation Operating Session".
 *
 ...
 * to its asset type (Site Operation). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Site Operation Operating Session";
